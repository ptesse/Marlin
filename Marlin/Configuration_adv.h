 ...
 */
//#define USE_CONTROLLER_FAN //<-- tbd
#if ENABLED(USE_CONTROLLER_FAN)
  //#define CONTROLLER_FAN_PIN -1        //<-- tbd // Set a custom pin for the controller fan
 ...
 */
//#define CASE_LIGHT_ENABLE //<-- tbd
#if ENABLED(CASE_LIGHT_ENABLE)
  //#define CASE_LIGHT_PIN 4                  //<-- tbd // Override the default pin if needed
...
#define TX_BUFFER_SIZE 0 //4MAX:4

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
//#define RX_BUFFER_SIZE 1024 /4MAX:enabled 256
 ...
 */
//#define EMERGENCY_PARSER //<-- 4max:enable
