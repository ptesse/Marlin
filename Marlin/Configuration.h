...
#define EXTRUDE_MAXLENGTH 200 //4MAX:600
 ...
 * :[2,3,4,5,6,7]
 */
//#define ENDSTOP_NOISE_THRESHOLD 2 //4MAX:enabled
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.038 // (mm) Distance from real junction edge
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR //<-- tbd
 ...
 */
#define LCD_BED_LEVELING //<-- check if it works
...
#define FAN_SOFT_PWM //<-- 4MAX:enabled
